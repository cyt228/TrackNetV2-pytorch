...
def parse_opt():
    ...
    parser.add_argument('--max-jump', type=int, default=500, help='Max jump distance in pixels')
    parser.add_argument('--max-speed', type=float, default=140.0, help='Max reasonable speed in km/h')
